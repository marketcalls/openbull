...
export function SandboxBanner() {
  ...
  return (
    <div
      className="flex items-center justify-center gap-2 border-b border-amber-500/40 bg-amber-500/10 px-4 py-1.5 text-xs font-medium text-amber-900 dark:text-amber-300"
      role="status"
      aria-live="polite"
    >
      <span
